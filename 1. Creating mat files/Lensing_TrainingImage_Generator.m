...
datapath = ['D:/lensed_images_3/'];
%galaxy_image_path = ['C:/Users/fedor/For jupyter/Ensai/data_galaxyzoo/images_training_rev1/'];
mkdir(datapath)
...
disp('loading...')
load('GREAT_IMS3.mat','GREAT_IMS');
n_source_sample = size(GREAT_IMS,2)
disp('done')
...
for i = 1:nsample
    ...
    image_ind = 3+ ceil(rand(1).*(n_source_sample-3));
    ...
    source_image = double(temp_src_im)* taper;
